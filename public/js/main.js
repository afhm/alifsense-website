/* Theme: AlifSense - Creative Web Design & Digital Marketing Agency HTML5 Template
Author: Rajesh-Doot	
...
(function ($) {
  ...
  $("[databackground]").each(function () {
    $(this).css("background-image", "url(" + $(this).attr("databackground") + ")");
  });
