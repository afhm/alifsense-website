  ...
  (function (a, b) {
    ...
    function c(c) {
      ...
      e[c] ||
        ...
        d && d.warn && !a.migrateMute && (d.warn('JQMIGRATE: ' + c), a.migrateTrace && d.trace && d.trace()));
    }
    function d(a, b, d, e) {
    ...
    (a.fn.init = function (a) {
      ...
      return (
        'string' == typeof a && '#' === a && (c("jQuery( '#' ) is not a valid selector"), (b[0] = [])), f.apply(this, b)
      );
    }),
          ...
          : (c('jQuery.fn.toggleClass( boolean ) is deprecated'),
            this.each(function () {
              ...
              c && a.data(this, '__className__', c),
                this.setAttribute &&
                  this.setAttribute('class', c || b === !1 ? '' : a.data(this, '__className__') || '');
            }));
      });
    var p = !1;
    a.swap &&
    ...
    a.data = function (b, d, e) {
      ...
      return d && d !== a.camelCase(d) && ((f = a.hasData(b) && q.call(this, b)), f && d in f)
        ? (c('jQuery.data() always sets/gets camelCased names: ' + d), arguments.length > 2 && (f[d] = e), f[d])
        : q.apply(this, arguments);
    };
    var r = a.Tween.prototype.run;
    a.Tween.prototype.run = function (b) {
      a.easing[this.easing].length > 1 &&
        (c('easing function "jQuery.easing.' + this.easing.toString() + '" should use only first argument'),
    ...
    (a.event.props = []),
      ...
      (a.event.fix = function (b) {
        ...
        if (
          f &&
          !f._migrated_ &&
          ((f._migrated_ = !0), c('jQuery.event.fixHooks are deprecated and removed: ' + e), (g = f.props) && g.length)
        )
        ...
        a.fn[d] = function () {
          ...
          return 'load' === d && 'string' == typeof a[0]
            ...
            : (c('jQuery.fn.' + d + '() is deprecated'),
              a.splice(0, 0, d),
              arguments.length ? this.on.apply(this, a) : (this.triggerHandler.apply(this, a), this));
        };
      }),
      a(function () {
    ...
    a.param = function (b, d) {
      ...
      return (
        void 0 === d && e && (c('jQuery.param() no longer uses jQuery.ajaxSettings.traditional'), (d = e)),
        v.call(this, b, d)
      );
    };
