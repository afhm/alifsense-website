  ...
  function ScrollSmoother(t) {
    ...
    Ka(),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t ? (u ? D.to(o, { duration: k, scrollTop: n, overwrite: 'auto', ease: Y }) : R(n)) : Ea(n);
      }),
    ...
    B.forEach(function (e) {
      ...
      (this.smooth = function (e) {
        return (
          arguments.length && ((_ = ((k = e || 0) && +t.speed) || 1), i.scrubDuration(e)),
      ...
      E && (this.normalizer = V.normalizeScroll(!0 === E ? { debounce: !0, content: !k && n } : E)),
      V.config(t),
      'overscrollBehavior' in O.getComputedStyle(J) && D.set([J, U], { overscrollBehavior: 'none' }),
      'scrollBehavior' in O.getComputedStyle(J) && D.set([J, U], { scrollBehavior: 'auto' }),
