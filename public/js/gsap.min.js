      ...
      if (
        ...
        if (
          ...
          if (
            (e && (y = !1),
            (a = qa(
              { overwrite: !1, data: 'isFromStart', lazy: y && !P && w(T), immediateRender: y, stagger: 0, parent: E },
              i
            )),
            p && (a[l.prop] = p),
          ...
          if (Z(x))
            ...
            for (l in u)
              for (
                ...
                ((D = { ease: (P = C[o]).e, duration: ((P.t - (o ? C[o - 1].t : 0)) / 100) * _ })[l] = P.v),
                  s.to(S, D, E),
                  (E += D.duration);
          ...
          !(function _renderZeroDurationTween(t, e, r, i) {
            ...
            if (
              ...
              e < 0 && Ca(t, e, 0, !0),
                ...
                (e >= t._tDur || e < 0) &&
                  t.ratio === u &&
                  (u && za(t, 1), r || B || (St(t, u ? 'onComplete' : 'onReverseComplete', !0), t._prom && t._prom()));
  ...
  var De,
    ...
    Cr = function _renderCSSTransforms(t, e) {
      ...
      _ !== Ar && (y += 'perspective(' + _ + Sr),
        (i || n) && (y += 'translate(' + i + '%, ' + n + '%) '),
        (!T && a === Ar && s === Ar && o === Ar) ||
          (y += o !== Ar || T ? 'translate3d(' + a + ', ' + s + ', ' + o + ') ' : 'translate(' + a + ', ' + s + Sr),
        u !== Mr && (y += 'rotate(' + u + Sr),
        h !== Mr && (y += 'rotateY(' + h + Sr),
        l !== Mr && (y += 'rotateX(' + l + Sr),
          ...
          if ('autoRound' !== c && ((o = e[c]), !pt[c] || !ac(c, e, i, n, t, a)))
            if (
                ...
                if (
                  ...
                  if ('transformOrigin' === c) {
                    b.push(dr, 0, x[dr]),
                      ...
                      v.svg
                        ? ke(t, o, 0, y, 0, this)
                        : ((p = parseFloat(o.split(' ')[2]) || 0) !== v.zOrigin && Xd(this, v, 'zOrigin', v.zOrigin, p),
              ...
              if (m || ((u || 0 === u) && (h || 0 === h) && !lr.test(o) && c in x))
                (u = u || 0),
                  (d = (s + '').substr((h + '').length)) !== (p = Ya(o) || (c in V.units ? V.units[c] : d)) &&
                    (h = $d(t, c, s, p)),
                  (this._pt = new ge(
                    this._pt,
                    m ? v : x,
