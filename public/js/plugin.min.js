  ...
  class t {
    ...
    updateInitialPosition() {
      ...
      this.onMouseEnter(),
        this.fullPageListening
          ...
          : (this.event = { clientX: this.left + ((this.settings.startX + this.settings.max) / (2 * this.settings.max)) * this.width, clientY: this.top + ((this.settings.startY + this.settings.max) / (2 * this.settings.max)) * this.height });
    ...
    update() {
      ...
      (this.element.style.transform =
        "perspective(" + this.settings.perspective + "px) rotateX(" + ("x" === this.settings.axis ? 0 : t.tiltY) + "deg) rotateY(" + ("y" === this.settings.axis ? 0 : t.tiltX) + "deg) scale3d(" + this.settings.scale + ", " + this.settings.scale + ", " + this.settings.scale + ")"),
...
!(function (a, b, c) {
  (a.fn.scrollUp = function (b) {
    ...
    (a.fn.scrollUp.defaults = { scrollName: "scrollUp", scrollDistance: 300, scrollFrom: "top", scrollSpeed: 300, easingType: "linear", animation: "fade", animationInSpeed: 200, animationOutSpeed: 200, scrollText: "Scroll to top", scrollImg: !1, activeOverlay: !1, zIndex: 2147483647 }),
...
!(function () {
  var s,
    ...
    c,
    a,
    o = { frameRate: 150, animationTime: 600, stepSize: 120, pulseAlgorithm: !0, pulseScale: 4, pulseNormalize: 1, accelerationDelta: 50, accelerationMax: 3, keyboardSupport: !0, arrowScroll: 50, fixedBackground: !0, excluded: "" },
    p = o,
    u = !1,
    d = !1,
    n = { x: 0, y: 0 },
...
!(function (e, t) {
                    ...
                    r.appendChild(h),
                      ...
                      e.items.forEach(function (e, t) {
                        ...
                        i
                          ...
                          Z.closeOnClick &&
                          (W()
                            ? "A" !== r.tagName || "false" === r.dataset.navClose || (null !== r.getAttribute("disabled") && "false" !== r.getAttribute("disabled")) || (e.subnav.length && (!r.getAttribute("href") || "#" === r.getAttribute("href").charAt(0))) || r.addEventListener("click", G)
                ...
                return function (e) {
                  ("left" !== Z.position && "right" !== Z.position) ||
                    ((o = e.touches[0].clientX),
                      ...
                      "doc" === t ? T || (ae.addEventListener("touchmove", q, R.supportsPassive), ae.addEventListener("touchend", D, R.supportsPassive)) : ((T = !0), v.addEventListener("touchmove", H, R.supportsPassive), v.addEventListener("touchend", I, R.supportsPassive)));
                };
              },
              j = function (e, t) {
  ...
  (function (n) {
    ...
    var d = function (e, t, n) {
      ...
      h = function (e, t, n) {
        console.warn(
          "%cHC Off-canvas Nav:%c " + n + "%c '" + e + "'%c is now deprecated and will be removed in the future. Use%c '" + t + "'%c option instead. See details about plugin usage at https://github.com/somewebmedia/hc-offcanvas-nav.",
          "color: #fa253b",
          "color: default",
          "color: #5595c6",
          "color: default",
      ...
      d.data && (c = a.extend(d.data, c)),
        ...
        a.each(c, function (c, d) {
          ...
          if (((e = c.split("_")), e.length > 1)) {
            ...
            if (f.length > 0) {
              var g = e[1];
              "replaceWith" === g ? f[0] !== d[0] && f.replaceWith(d) : "img" === g ? (f.is("img") ? f.attr("src", d) : f.replaceWith(a("<Image >").attr("src", d).attr("class", f.attr("class")))) : f.attr(e[1], d);
            }
      ...
      _preloadItem: function (c) {
        if (((c = S(c)), !b.items[c].preloaded)) {
          ...
          d.parsed || (d = b.parseEl(c)),
            y("LazyLoad", d),
            "image" === d.type &&
            (d.img = a('<Image  width={100} height={100} class="mfp-img" />')
    ...
    (this.WOW = (function () {
      ...
      return (
        ...
        (e.prototype.applyStyle = function (a, b) {
          var c, d, e;
          return (
            (d = a.getAttribute("datawowduration")),
            (c = a.getAttribute("datawowdelay")),
            (e = a.getAttribute("datawowiteration")),
            this.animate(
              (function (f) {
                return function () {
        ...
        (e.prototype.isVisible = function (a) {
          var b, c, d, e, f;
          return (c = a.getAttribute("datawowoffset") || this.config.offset), (f = window.pageYOffset), (e = f + Math.min(this.element.clientHeight, this.util().innerHeight()) - c), (d = this.offsetTop(a)), (b = d + a.clientHeight), e >= d && b >= f;
        }),
...
var rellax = new Rellax(".alifsense");
